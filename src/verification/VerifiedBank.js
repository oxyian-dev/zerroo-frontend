    ...
    return (
        <Stack spacing={2}>
            <Card variant="outlined">
                <CardContent>
                    <Typography variant="h2" textAlign="center">Verified Bank</Typography>
                </CardContent>
            </Card>
            <ServerDataGrid
                width={width}
                render={render}
                datatype={datatype}
                ajax={{ url: '/api/verification/bank/verified' }}
                columns={[
                    ...
                    { "headerName": "Verified Time", "field": "Verified Time", "width": "200", "id": "Verified Time", "type": "dateTime" },
