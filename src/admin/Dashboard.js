...
const cards = [
  ...
  { key: 'current_cutoff_income', label: 'Current Cutoff Income (Qualification + 1:1 Pair)', accent: 'red', link: null, isCurrency: true },
  { key: 'qualification_income_lifetime', label: 'Qualification Income (Lifetime Gross)', accent: 'orange', link: null, isCurrency: true },
  { key: 'pair_match_income_lifetime', label: '1:1 Pair Match Income (Lifetime Gross)', accent: 'pink', link: null, isCurrency: true },
