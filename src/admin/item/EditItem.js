    ...
    return loading ? (
        ...
        <Formik
            ...
            onSubmit={async (values, { setSubmitting }) => {
                setSubmitting(true)
                return await fetcher(`/api/items/${id}`,
            ...
            initialValues={nonull({ ...defaultValues, reason: '' })}>
            {({
                errors,
                handleBlur,
                handleChange,
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Card variant="outlined">
                                <CardContent>
                                    <Typography variant="h2" textAlign="center">Edit Item</Typography>
                                </CardContent>
                            </Card>
                        </Grid>
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth error={Boolean(touched.reason && errors.reason)}>
                                <TextField
                                    ...
                                    onChange={handleChange}
                                    label="Reason"
                                    helperText="Enter the reason to edit this Item"
                                />
