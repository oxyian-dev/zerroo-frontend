...
const Gst = () => {
    ...
    return (
        <Box>
            ...
            <Typography my={2}>Select from and to date to export GST data</Typography>
            <form noValidate action={`${PROXY}/api/sale-orders/export`} method="post" onSubmit={exportGst}>
