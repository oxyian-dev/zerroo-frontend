...
export default function PrivacyPolicy() {
    return (
        <Container sx={{ my: 4 }}>
            ...
            <Stack spacing={2}>
                <Typography>
                    The purpose of this Privacy Policy is to inform you about the type of information we may collect when you visit <a href="http://www.zerroo.in" target="_blank" rel="noopener noreferrer">www.zerroo.in</a>
                    , how we may use the information and the choices you have regarding our use of your information and your ability to correct the information or its use at any point.
                </Typography>
                <Typography>
                    We, ZERABIZ ECOM LLP  (<a href="http://www.zerroo.in" target="_blank" rel="noopener noreferrer">www.zerroo.in</a>
                    ), consider your privacy as very important to us. Our relationship with you is our most valuable asset and is the very basis of our name and reputation. We understand the importance you place on the privacy and security of information that personally identifies you or your account information. We refer to and treat this information as “personal information”.
                </Typography>
                <Typography>
                ...
                <Typography>
                    * Zerabiz Ecom LLP corporates  policies require that employees with access to confidential customer information may not use or disclose the information except for business use. All employees are required to safeguard such information, as specified in their confidentiality agreements with Zerabiz Ecom LLP.
                </Typography>
                <Typography>
...
`
                    ...
                    {
                        question: "Security",
                        answer: `This site has security measures in place to protect the loss, misuse, and/or alteration of information under our control. The data resides behind a firewall, with access restricted to authorized Immunorich Marketing Pvt. Ltd (<a href="http://www.zerroo.in" target="_blank" rel="noopener noreferrer">www.zerroo.in</a>
)`
                    },
                    {
