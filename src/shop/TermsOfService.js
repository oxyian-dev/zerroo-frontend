...
. (the “Site”) is owned and operated by Zerabiz Ecom LLP  (“we” or “us” or Zerabiz Ecom LLP), a company incorporated under the laws of India and having its Registered Office at 5/837, Naal road, Thennampatti, Vedasandur (Taluk), Dindigul -624802, India. By using this Site, you agree to the terms and conditions which constitute the entire agreement between Zerabiz Ecom LLP and you. These Terms supersede all prior and contemporaneous representations, warranties and understandings, whether oral or written with respect to the Site, its contents and any services provided on the site. In the event of any conflict between these Terms and any agreement or understanding related to the Site, the Terms shall control.
 ...
 for sale, trade or other commercial purposes. Users may not use language that is threatening, abusive, vulgar, discourteous or criminal. Users also may not post or transmit information or materials that would violate rights of any third party or which contains a virus or other harmful component Zerabiz Ecom LLP  reserves the right to remove or edit any messages or material submitted by users.
                ...
                <Typography>
                    Zerabiz Ecom LLP does not warrant that this site, its servers, or e-mail sent Zerabiz Ecom LLP  are free of viruses or other harmful components. Zerabiz Ecom LLP  will not be liable for any damages of any kind arising from the use of this site, including, but not limited to direct, indirect, incidental, punitive, and consequential damages.
                </Typography>
                <Typography>
                    * The User understands and acknowledges that any links which takes the User to third party sites is not maintained by Zerabiz Ecom LLP  and Zerabiz Ecom LLP  privacy policy does not apply. This link is provided to you for convenience and does not serve as an endorsement by Zerabiz Ecom LLP of any information or contacts that you may find on this non- Zerabiz Ecom LLP Under no circumstances, including but not limited to negligence, will Zerabiz Ecom LLP  be liable for special or consequential damages that result from the use or inability to use the materials in this site.
                </Typography>
                <Typography>
                ...
                <Faq faqs={[
                    ...
                    },
                    {
                        ...
                        answer: `Any information or material submitted by you to Zerabiz Ecom LLP website [www.zerroo.in]  (whether through e-mail, written letter or otherwise) will be deemed non-proprietary and non-confidential, and may be used Zerabiz Ecom LLP without restriction. Not with standing the foregoing, all personal data (e.g., name, address and telephone number) provided Zerabiz Ecom LLP will be handled in accordance with Zerabiz Ecom LLP  Policy.`
                    },
                    {
