...
const DeclarationContent = () => {
  ...
  return loading ? (
    ...
    <Typography variant="body2" sx={{ textAlign: "justify" }}>
      •   This contract is made between the	Applicant (herein after	 referred to as “Distributor” or “He/She”) and Victory World, which is a company incorporated under	the Companies	Act, 2008, having its registered office at 5/837, Naal road, Thennampatti, Vedasandur (Taluk), Dindigul- 624802, Tamilnadu, India.
      (herein after	 referred as “Victory World” or “company” or “we” or “us”) on a principal-to-principal basis.
      ...
      <br></br>• The undersigned Distributor acknowledges that he / she	has read, understood and accepted  all	  the terms & conditions of this Agreement Form and also	 agrees	to comply by all the terms mentioned	on the company's website www.victoryworld.in.
      <br></br>•The	distributor also agrees	 to read	 and comply by	 further amendments,	which	will be	made from time to time.<br></br>

      <br></br><b>The	 terms & conditions agreed by the Distributor and the Company	is as	under:</b><br></br>

      <br></br>1.Each applicant should be at	least 18 years of age at the time of application, to become an Victory World Distributor. He/she  is capable of taking independent decision, of sound mind and has not been convicted by any court of law for any offence classified as economic offence or  of moral turpitude. He/she further undertakes not  to use any unethical means and not  to sell/ to refer/ to build Network (s) against the policies of the company.<br></br>
      ...
      <br></br>4.The company may approve the Distributorship by an online registration, which will carry the password and an identification number known as ID as chosen automatically. The ID once created will not be altered later at any point of time. He/she will be authorised to start a business as a distributor only after completion of KYC procedure and purchasing the 80 PV qualifying product of Victory World, with no time limit.<br></br>
      ...
      <br></br>6.This form is an application	and an	agreement to appoint an individual as a self-employed Distributor for the sale of Victory World Products. Signing of this form in no way makes you an employee or agent of the company. Distributors
      are not permitted under any circumstances  to market or deal in any manner with any product/ services, which are not approved by Victory World in	their network.	He/she  is permitted to sell the products/services on	an e-commerce platform /market place, only if he/she has	taken prior written consent from Victory World  to do the same. He/she shall not be involved directly or indirectly (including by proxy) in  any activities of other direct sales companies or any other activities  that will bring negative effects to Victory World. Victory World  reserves the right to terminate any distributor who commits such offence.<br></br>
      ...
      <br></br>9.The	Distributor shall  attend the mandatory orientation (face to face/ online session) given by Victory World regarding provision of fair and accurate information	on all aspects of the direct selling operation, remuneration system and expected remuneration for	newly recruited Distributors.	The date of such an orientation session will be available to the  distributor either on the Company’s Website or inform by	the sms or whatsapp on his/her registered mobile number.<br></br>

      <br></br>10.I authorized you to send sms/email related to Victory World Business	on my mobile number/email id registered with the	company.<br></br>

      <br></br>11.In	case of	any grievance or complaint received by the Distributor from  a customer regarding any product of Victory World  sold in pursuance	of this contract, the Distributor shall refer such complaint to	the Grievance	Redressal Committee	which	shall address such grievances	within	30 (Thirty) days. The decision	of the Grievance Committee	regarding such	complaints shall be final.<br></br>

      <br></br>12. No 	monetary gain	is guaranteed by the company.	 Remuneration	 depends upon	solely on the distributor's work, efforts and performance. For further detail	 please	check the business plan on www.victoryworld.in.<br></br>
      ...
      <br></br>14.The undersigned confirms hat he/she has not joined Victory World under any other Network.<br></br>

      <br></br>15. Victory World agrees to allow the cooling off period, as	provided under Government guidelines, in order to cancel/withdraw, the Independent	Distributorship and to	receive	refund	for goods or services purchased and further agrees to allow buy	- back/ repurchase as per the policies of the company.	 (Kindly read the terms and condition  mentioned on the company's website www.victoryworld.in more details.)<br></br>
      ...
      <br></br>17.That I have read and understood the terms and conditions for appointment of Victory World Retailer/ Distributors (Direct Seller) of the company, and accept to them.<br></br>
      ...
      <br></br>I hereby declared that	I am resident of India,	my age	is more  than 18 years	as on date. I am legally	qualified to do any business or agreement or declaration	 in India. I have	no criminal history. I am qualified to do Victory World business in India. I have read and	understood the contents of the above	agreements and I will abide by  the above. I also confirm that I know my sponsor and have full	faith in	him. The legal	provisions were explained to me (in the language I understand) by my sponsor and I make myself legally bound	by the above.<br></br>

      <br></br>I hereby declared that	Applicant/Distributor(s) is known to me. I take responsibility for the face that he/she applied for Victory World Products	distributorship only after he/she has	read and I have	 explained him/her (in	the language he/she	understands) about the company, company's	products, sales	&marketing plan, Company's the application	of Policy	and terms & conditions. I reconfirm that all information and	declaration given by Applicant/Distributor(s)	is true. I	recommend that Victory World should accept Applicant/Distributor(s) for	distributorship of its products	and services. Thankyou.<br></br>
